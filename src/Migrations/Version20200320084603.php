 ...
 */
final class Version20200320084603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stat (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, contaminated INT DEFAULT NULL, healed INT DEFAULT NULL, zombified INT DEFAULT NULL, stat_date DATE NOT NULL, INDEX IDX_20B8FF21F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
